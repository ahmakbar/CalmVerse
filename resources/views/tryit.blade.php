      ...
      <div class="project-try">
        <header>
            <div class="container-2">
                 <div class="nav">
                     <h1>CalmVerse</h1>
                     <div class="">
                         <button onclick="showCreateCardBox()">Add New</button>
                         <button onclick="delFlashcards()">Del Card</button>
        ...
        <div class="container-2">
         <div class="create-box">
             ...
             <textarea name="" id="quotes"></textarea>
             <div class="">
                 <button onclick="addFlashcard()">Save</button>
                 <button onclick="hideCreateBox()">Cancel</button>
             </div>
         </div>
